...
public static class DbSeeder
{
    public static async Task SeedAsync(AppDbContext db)
    {
        ...
        // ── Gym ───────────────────────────────────────────────────────────────
        // Seeded demo gym is Active immediately, so the demo admin login keeps working.
        var gym = new Gym
        {
            Id = Guid.NewGuid(),
        ...
        // ── Users ─────────────────────────────────────────────────────────────
        // GymAdmin for the demo gym (existing demo credentials keep working)
        var admin = new User
        {
            Id = Guid.NewGuid(),
            Name = "Admin User",
        ...
        // SuperAdmin — not scoped to any gym, oversees the whole platform
